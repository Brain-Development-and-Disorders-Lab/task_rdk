...
if (keyLayout.name === 'spectrometer') {
  instructionContinueText =
    `<div id="instructions-navigation">
      <br>
      <hr>
      <img src="${Configuration.stimuli['ControlsNavigationSpectrometer.png']}"
  ...
  instructionContinueText =
    `<div id="instructions-navigation">
      <br>
      <hr>
      <img src="${Configuration.stimuli['ControlsNavigationDesktop.png']}"
        style="${Configuration.style.controls}">
    </div>`;
}
...
if (keyLayout.name === 'spectrometer') {
  leftControlImage =
    `<img
      src="${Configuration.stimuli['2.png']}"
      style="${Configuration.style.keyboard}"
    >`;
  rightControlImage =
    `<img
      src="${Configuration.stimuli['3.png']}"
      style="${Configuration.style.keyboard}"
    >`;
  submitControlImage =
    `<img
      src="${Configuration.stimuli['4.png']}"
      style="${Configuration.style.keyboard}"
    >`;
} else {
  leftControlImage =
    `<img
      src="${Configuration.stimuli['F.png']}"
      style="${Configuration.style.keyboard}"
    >`;
  rightControlImage =
    `<img
      src="${Configuration.stimuli['J.png']}"
      style="${Configuration.style.keyboard}"
    >`;
  submitControlImage =
    `<img
      src="${Configuration.stimuli['K.png']}"
      style="${Configuration.style.keyboard}"
    >`;
}
...
if (keyLayout.name === 'spectrometer') {
  controlInstructions =
    `<div>
      <img
        src="${Configuration.stimuli['ControlsQuestionSpectrometer.png']}"
        style="${Configuration.style.controls}"
      >
    </div>`;
} else {
  controlInstructions =
    `<div>
      <img
        src="${Configuration.stimuli['ControlsQuestionDesktop.png']}"
        style="${Configuration.style.controls}"
      >
    </div>`;
}
...
const description = [
  ...
  `<p>An example illustrating the appearance of these dots is ` +
    `shown below:</p>` +
  `<img src="${Configuration.stimuli['InstructionsMovingDots.gif']}" ` +
  ...
  `<img src="${Configuration.stimuli['InstructionsReference.png']}" ` +
      `style="${Configuration.style.image}"/>` +
  ...
  `<img src="${Configuration.stimuli['InstructionsConfidence.png']}" ` +
      `style="${Configuration.style.image}"/>` +
  `<p>Press ${leftControlImage} ` +
...
const practice = [
  ...
  <h2>Practice Games</h2>
  <p>
    You will now play another ${Configuration.manipulations.numPracticeTrials} 
    practice games. You won't have to rate your confidence after each game, 
  ...
  <p>
    ...
    middle of the screen will briefly turn red.
  </p>`,
  instructionContinueText,
];
...
function calculateDuration() {
  ...
  let total = Configuration.manipulations.numTutorialTrials +
