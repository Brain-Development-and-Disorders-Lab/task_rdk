...
window.onload = () => {
  ...
  if (Configuration.target === "gorilla") {
    ...
    new Manipulations(Configuration.trials, [
      "numTutorialTrials",
      "numPracticeTrials",
  ...
  if (keyLayout.name === "spectrometer") {
    leftControlImage =
      `<img src="${imageCollection["2.png"]}" ` +
      `style="${Configuration.style.keyboard}"> `;
    rightControlImage =
      `<img src="${imageCollection["3.png"]}" ` +
      `style="${Configuration.style.keyboard}"> `;
    submitControlImage =
      `<img src="${imageCollection["4.png"]}" ` +
      `style="${Configuration.style.keyboard}"> `;
  } else {
    leftControlImage =
      `<img src="${imageCollection["F.png"]}" ` +
      `style="${Configuration.style.keyboard}"> `;
    rightControlImage =
      `<img src="${imageCollection["J.png"]}" ` +
      `style="${Configuration.style.keyboard}"> `;
    submitControlImage =
      `<img src="${imageCollection["K.png"]}" ` +
      `style="${Configuration.style.keyboard}"> `;
  }
  ...
  if (keyLayout.name !== "spectrometer") {
    timeline.push({
      ...
      feedback_correct:
        "Correct! You will have to guess the " +
  ...
  function calculateDuration() {
    ...
    let total =
      Configuration.trials.numTutorialTrials +
